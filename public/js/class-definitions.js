 ...
 *
 */
var galilean_moons = ['Io', 'Ganymede', 'Callisto', 'Europa'];
...
Meal.prototype.containsJunkFood = function () {
  if (this.foods.indexOf('chips') !== -1)
      return true;
  if (this.foods.indexOf('soda') !== -1)
      return true;
  if (this.foods.indexOf('ice cream') !== -1)
      return true;
  if (this.foods.indexOf('popcorn') !== -1)
      return true;
  if (this.foods.indexOf('candy') !== -1)
      return true;
...
var notWarmOrColdAnimal = new Animal('Skunk').isWarmBlooded();
...
var polygon = new Shape(99).getType();
...
var cookieMonsterBlocked = new Cookie('chocolate').swipedByCookieMonster("Not-A-Day");
 ...
 *
 */
var badForYou = new Meal(['ice cream', 'candy']).containsJunkFood();
var goodForYou = new Meal(['steak', 'potatoes']).containsJunkFood();
